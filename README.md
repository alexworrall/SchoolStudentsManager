...
* <a href="https://firebase.google.com">Firebase - Cloud based real time database used with API for retrieving all application information as JSON</a>
* <a href="https://developers.google.com/maps/documentation/javascript/overview">Google Maps Javascript API for showing map information and user location</a>
